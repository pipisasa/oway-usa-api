...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("id", "unique_id", "first_name", "last_name", "email", "avatar", "phone_number", "front_image", "back_image", "created_at", "user_address")
...
class ProfileUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("id", "first_name", "last_name", "email", "avatar", "phone_number", "front_image", "back_image", "user_address")
